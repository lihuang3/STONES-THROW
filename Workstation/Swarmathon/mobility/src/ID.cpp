...
//Todo
   ...
   // Todo
    hostIDSubscriber = mNH.subscribe("hostID", 1000, hostIDHandler);
    
    hostIDPublisher = mNH.advertise<std_msgs::String>(("hostID"), 1000, true);
